...
Account Number : {customer_details[9]}"""
            if customer_details[3] == finiding_email_var.get().strip() and customer_details[-1] == finding_password_entry.get():
...
find_button = tk.Button(frame, text= "Find", fg= "blue", command= finding).grid(row=6, column=13)
